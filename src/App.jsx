...
const SkillTag = ({ label }) => {
  ...
  return (
    <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 border border-slate-200 text-slate-700 font-mono text-xs tracking-wide">
...
export default function StuartClarkPortfolio() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900">
      ...
      {/* Navigation */}
      <nav className="fixed top-0 left-0 right-0 bg-white/80 backdrop-blur-md border-b border-slate-200 z-40 mt-0.5">
        <div className="max-w-6xl mx-auto px-6 py-3">
          <div className="flex items-center justify-between">
            <div className="font-semibold text-lg tracking-tight text-slate-900">Stuart Clark</div>
              ...
              {['home', 'about', 'project', 'skills', 'experience', 'contact'].map(section => (
                <button
                  ...
                  className={`capitalize transition-colors ${
                    activeSection === section ? 'text-blue-600 font-medium' : 'text-slate-700 hover:text-slate-900'
                  }`}
                >
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-slate-50 border-t border-slate-200 px-6 py-4 space-y-1">
            {['home', 'about', 'project', 'skills', 'experience', 'contact'].map(section => (
              <button
                key={section}
                onClick={() => scrollToSection(section)}
                className={`block w-full text-left py-3 capitalize text-sm font-mono transition-colors border-b border-slate-100 last:border-0 ${
                  activeSection === section ? 'text-blue-600 font-medium' : 'text-slate-700'
                }`}
              >
                {section === 'project' ? 'Projects' : section}
              </button>
        ...
        <div className="max-w-4xl mx-auto w-full">
          <div className="flex flex-col md:flex-row md:items-center gap-8 md:gap-12">
            ...
            <div className="flex-1">
              ...
              <h1 className="text-5xl md:text-7xl font-bold mb-6 animate-[fadeIn_0.8s_ease-out] leading-tight text-slate-900">
                ML Engineer for<br />
                regulated, high-stakes domains
              </h1>

              <p className="text-xl md:text-2xl text-slate-700 mb-8 max-w-2xl animate-[fadeIn_1s_ease-out] leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row gap-4 items-start animate-[fadeIn_1.2s_ease-out]">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 px-6 py-3 border border-slate-200 text-slate-700 rounded-sm hover:border-blue-600 hover:text-blue-600 transition-colors"
                >
                  <FileText size={20} />
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              <div className="bg-slate-50 p-6 rounded-sm border border-slate-200">
                <h3 className="font-semibold text-lg mb-3 text-slate-900">What I Bring</h3>
              ...
              <div className="bg-slate-50 p-6 rounded-sm border border-slate-200">
                <h3 className="font-semibold text-lg mb-2 text-slate-900">Currently Seeking</h3>
      ...
      <section id="project" className="min-h-screen px-6 py-20 bg-slate-50">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold mb-4 text-slate-900">Projects</h2>
          ...
          <div className="bg-white rounded-sm overflow-hidden border border-slate-200">
            <div className="p-6 space-y-6">
              {/* Dissertation Title */}
              <div>
                <div className="inline-flex items-center gap-2 px-3 py-1 bg-blue-600 text-white text-xs font-mono tracking-wide mb-3">
                  <Award size={14} />
                  MSc Dissertation
                </div>
                <h3 className="text-2xl font-bold mb-2 text-slate-900">Predicting Incident Severity from Safety Reports Using Transformer Models and Explainable AI</h3>
                <p className="text-slate-700">Fine-tuned BERT-family models on 180,000+ OSHA incident records to classify severity, using SHAP to surface model reasoning and enable responsible deployment as a decision-support tool.</p>
              </div>

              {/* Key Finding */}
              <div className="bg-slate-50 p-6 border-l-4 border-blue-600">
                <h3 className="font-semibold text-lg mb-2 text-slate-900">Key Finding</h3>
              ...
              <div className="border-t border-slate-200 pt-6">
                ...
                <div className="grid sm:grid-cols-3 gap-3">
                  ...
                  >
                    ...
                    <div>
                      <div className="font-medium text-sm text-slate-900">Dissertation PDF</div>
                      <div className="text-xs text-slate-500 font-mono">Full paper</div>
                    </div>
                  </a>
                  ...
                  <a
                    ...
                    className="flex items-center gap-3 p-4 bg-slate-50 hover:bg-slate-100 transition-colors border border-slate-200"
                  >
                    <Video size={20} className="text-slate-700 flex-shrink-0" />
                    <div>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-xs text-blue-200 font-mono">Try the prototype</div>
                    </div>
                  </a>
                </div>
              </div>
          ...
          {/* RAG Triage API */}
          <div className="bg-white rounded-sm overflow-hidden border border-slate-200 mt-8">
            <div className="p-6 space-y-6">
              <div className="bg-slate-50 p-6 border-l-4 border-blue-600">
                <div className="inline-flex items-center gap-2 px-3 py-1 bg-blue-600 text-white text-xs font-mono tracking-wide mb-3">
                  <Award size={14} />
                ...
                <h3 className="text-2xl font-bold mb-2 text-slate-900">Care Home Incident Triage API</h3>
                <p className="text-slate-700 leading-relaxed">
              ...
              <div className="border-t border-slate-200 pt-6">
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3">
                  ...
                  >
                    ...
                    <div>
                      <div className="font-medium text-sm text-slate-900">GitHub Repository</div>
                      <div className="text-xs text-slate-500 font-mono">View source code</div>
                    </div>
                  </a>
          ...
          <div className="bg-white rounded-sm overflow-hidden border border-slate-200 mt-8">
            <div className="p-6 space-y-6">
              <div className="bg-slate-50 p-6 border-l-4 border-blue-600">
                ...
                <h3 className="text-2xl font-bold mb-2 text-slate-900">OHS Document Intelligence Pipeline</h3>
                <p className="text-slate-700 leading-relaxed">
      ...
      <section id="skills" className="flex items-center px-6 py-24 bg-white">
        <div className="max-w-5xl mx-auto w-full">
          <h2 className="text-4xl md:text-5xl font-bold mb-12 text-center text-slate-900">Technical Skills</h2>

          <div className="grid md:grid-cols-2 gap-8">
            {/* Machine Learning & AI */}
            <div className="bg-slate-50 p-8 border border-slate-200">
              <h3 className="text-xl font-semibold mb-6 text-slate-900">Machine Learning & AI</h3>
              <div className="space-y-4">
                <div>
                  <div className="flex justify-between mb-2">
                    <span className="font-medium text-slate-700 text-sm font-mono tracking-wide">Natural Language Processing</span>
                  </div>
                  <div className="flex flex-wrap gap-2">
                    <SkillTag label="BERT" />
                    <SkillTag label="DistilBERT" />
                    <SkillTag label="ModernBERT" />
                    <SkillTag label="Transformers" />
                  </div>
                </div>

                <div>
                  <div className="flex justify-between mb-2">
                    <span className="font-medium text-slate-700 text-sm font-mono tracking-wide">LLMs & Generative AI</span>
                  </div>
                  <div className="flex flex-wrap gap-2">
                ...
                <div>
                  <div className="flex justify-between mb-2">
                    <span className="font-medium text-slate-700 text-sm font-mono tracking-wide">Vector Search & Embeddings</span>
                  </div>
                  <div className="flex flex-wrap gap-2">
                    <SkillTag label="ChromaDB" />
                    <SkillTag label="Sentence Transformers" />
                    <SkillTag label="HuggingFace" />
                  </div>
                </div>

                <div>
                  <div className="flex justify-between mb-2">
                    <span className="font-medium text-slate-700 text-sm font-mono tracking-wide">ML Frameworks & Explainability</span>
                  </div>
                  <div className="flex flex-wrap gap-2">
                    <SkillTag label="PyTorch" />
                    <SkillTag label="Scikit-learn" />
                    <SkillTag label="SHAP" />
                    <SkillTag label="Optuna" />
            ...
            <div className="bg-slate-50 p-8 border border-slate-200">
              <h3 className="text-xl font-semibold mb-6 text-slate-900">Programming & Deployment</h3>
              <div className="space-y-4">
                <div>
                  <div className="flex justify-between mb-2">
                    <span className="font-medium text-slate-700 text-sm font-mono tracking-wide">Languages & Data Science</span>
                  </div>
                  <div className="flex flex-wrap gap-2">
                    <SkillTag label="Python" />
                    <SkillTag label="SQL" />
                    <SkillTag label="Java" />
                    <SkillTag label="Pandas" />
                    <SkillTag label="NumPy" />
                    <SkillTag label="Matplotlib" />
                  </div>
                </div>

                <div>
                  <div className="flex justify-between mb-2">
                    <span className="font-medium text-slate-700 text-sm font-mono tracking-wide">APIs & Backend</span>
                  </div>
                  <div className="flex flex-wrap gap-2">
                    <SkillTag label="FastAPI" />
                    <SkillTag label="Pydantic v2" />
                    <SkillTag label="Streamlit" />
                    <SkillTag label="REST APIs" />
                  </div>
                </div>

                <div>
                  <div className="flex justify-between mb-2">
                    <span className="font-medium text-slate-700 text-sm font-mono tracking-wide">Cloud & Deployment</span>
                  </div>
                  <div className="flex flex-wrap gap-2">
                    <SkillTag label="AWS ECS Fargate" />
                    <SkillTag label="AWS S3" />
                    <SkillTag label="Vercel" />
                    <SkillTag label="Railway" />
                    <SkillTag label="Streamlit Cloud" />
                  </div>
                </div>

                <div>
                  <div className="flex justify-between mb-2">
                    <span className="font-medium text-slate-700 text-sm font-mono tracking-wide">Document Processing</span>
                  </div>
                  <div className="flex flex-wrap gap-2">
                    <SkillTag label="PyMuPDF" />
                    <SkillTag label="OCR" />
                    <SkillTag label="Multimodal AI" />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="mt-8 bg-slate-50 p-8 border border-slate-200">
            <h3 className="text-xl font-semibold mb-4 text-slate-900">Domain Expertise</h3>
            <div className="flex flex-wrap gap-2">
              <span className="px-2.5 py-0.5 border border-slate-200 text-slate-700 font-mono text-xs tracking-wide">Occupational Safety</span>
              <span className="px-2.5 py-0.5 border border-slate-200 text-slate-700 font-mono text-xs tracking-wide">Risk Management</span>
              <span className="px-2.5 py-0.5 border border-slate-200 text-slate-700 font-mono text-xs tracking-wide">Safety Auditing</span>
              <span className="px-2.5 py-0.5 border border-slate-200 text-slate-700 font-mono text-xs tracking-wide">Regulatory Compliance</span>
              <span className="px-2.5 py-0.5 border border-slate-200 text-slate-700 font-mono text-xs tracking-wide">Food Safety</span>
              <span className="px-2.5 py-0.5 border border-slate-200 text-slate-700 font-mono text-xs tracking-wide">MCIEH</span>
              <span className="px-2.5 py-0.5 border border-slate-200 text-slate-700 font-mono text-xs tracking-wide">NEBOSH</span>
              <span className="px-2.5 py-0.5 border border-slate-200 text-slate-700 font-mono text-xs tracking-wide">Health & Social Care</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="experience" className="px-6 py-24 bg-slate-50">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold mb-12 text-center text-slate-900">Professional Journey</h2>
          ...
          <div className="relative">
            ...
            <div className="space-y-12">
              ...
              <div className="relative md:pl-20 pl-0">
                ...
                <div className="bg-white p-6 border border-slate-200">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-3">
                    <h3 className="text-xl font-semibold text-slate-900">NEBOSH Diploma — Advanced Professional Development</h3>
                    <span className="text-sm text-slate-500 mt-1 sm:mt-0 font-mono">Mar 2019 – Mar 2022</span>
                  </div>
              ...
              <div className="relative md:pl-20 pl-0">
                ...
                <div className="bg-white p-6 border border-slate-200">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-3">
                    <h3 className="text-xl font-semibold text-slate-900">Senior Health and Safety Consultant</h3>
                    <span className="text-sm text-slate-500 mt-1 sm:mt-0 font-mono">May 2011 – Mar 2019</span>
                  </div>
                  <div className="text-slate-700 font-medium mb-2">NAVITAS / Local Government</div>
      ...
      <section id="contact" className="flex items-center px-6 py-24 bg-white">
        <div className="max-w-4xl mx-auto w-full">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              <div className="bg-slate-50 p-8 border border-slate-200">
                <h3 className="font-semibold text-xl mb-6 text-slate-900">Get in Touch</h3>
                ...
                <div className="space-y-4">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-4 p-4 bg-white hover:shadow-md transition-shadow border border-slate-200"
                  >
                    ...
                    <div>
                      ...
                      <div className="text-sm text-slate-500 font-mono">Professional profile</div>
                    </div>
                  </a>
                  ...
                  <div className="flex items-center gap-4 p-4 bg-white border border-slate-200">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-slate-500 font-mono">stuartclarkfc@gmail.com</div>
                    </div>
                  </div>
                </div>
              ...
              <a
                ...
                className="flex items-center justify-center gap-2 w-full p-4 bg-blue-600 text-white hover:bg-blue-700 transition-colors"
              >
                <Download size={20} />
                Download CV/Resume
              </a>
            ...
            <div className="space-y-6">
              <div className="bg-slate-50 p-8 border border-slate-200">
                <h3 className="font-semibold text-xl mb-4 text-slate-900">Open to Opportunities</h3>
                <ul className="space-y-3 text-slate-700">
                  <li className="flex items-start gap-3">
              ...
              <div className="bg-slate-50 p-8 border border-slate-200">
                <h3 className="font-semibold text-lg mb-3 text-slate-900">Ideal Projects</h3>
                <p className="text-slate-700 mb-3">
      ...
      <footer className="bg-slate-900 text-slate-400 py-12 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex gap-4">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-slate-800 flex items-center justify-center hover:bg-blue-600 transition-colors"
              >
                <Linkedin size={20} />
              </a>
            </div>
          ...
          <div className="mt-8 pt-8 border-t border-slate-800 text-center text-sm text-slate-500 font-mono">
