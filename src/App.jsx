  ...
  return (
    <div className="min-h-screen bg-[#F3EEE2] text-[#181614]">
      ...
      <div className="fixed top-0 left-0 w-full h-0.5 bg-[#C8BFB0] z-50">
        <div
          className="h-full bg-[#AA342C] transition-all duration-300"
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-6 items-start">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block overflow-hidden border border-[#C8BFB0] hover:shadow-md transition-shadow"
                >
                  <img
                    src="/infographic.png"
                ...
                <div className="grid sm:grid-cols-3 gap-3">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-xs text-[#C8BFB0] font-mono">Try the prototype</div>
                    </div>
                  </a>
                </div>
              </div>
              ...
              <div className="border-t border-[#C8BFB0] pt-6">
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3">
                  ...
                  >
                    ...
                    <div>
                      <div className="font-medium text-sm">Live Demo</div>
                      <div className="text-xs text-[#C8BFB0] font-mono">Try the app</div>
                    </div>
                  </a>
                </div>
              </div>
      ...
      <section id="experience" className="px-6 py-24 bg-[#F3EEE2]">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="relative">
            {/* Timeline Line */}
            <div className="absolute left-8 top-0 bottom-0 w-0.5 bg-[#C8BFB0] hidden md:block" />
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex gap-4">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-[#281E18] flex items-center justify-center hover:bg-[#AA342C] transition-colors"
              >
                <Linkedin size={20} />
              </a>
            </div>
